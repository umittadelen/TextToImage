...
document.getElementById('ChangeIpButton').addEventListener('click', () => {
    const newIpPort = prompt("Enter the server IP and port (format: ip:port):");
    if (newIpPort) {
        localStorage.setItem('serverIpPort', newIpPort);
    }
